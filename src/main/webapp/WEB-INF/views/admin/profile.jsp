    ...
    <div class="farmer-profile-layout">
        <div class="farmer-profile-side">
            <div class="farmer-profile-avatar-card">
                <div class="farmer-profile-avatar-box">
                    <img id="adminProfileAvatarPreview" src="${entity.avatar}" alt="头像预览" class="${empty entity.avatar ? 'd-none' : ''}">
                    <div id="adminProfileAvatarEmpty" class="register-avatar-empty ${empty entity.avatar ? '' : 'd-none'}">头像</div>
                </div>

                <input type="hidden"
                       id="adminProfileAvatar"
                       class="js-image-url-input"
                       data-preview="#adminProfileAvatarPreview"
                       data-empty="#adminProfileAvatarEmpty"
                       data-sync-group="admin-profile-avatar"
                       value="${entity.avatar}">

                <div class="custom-file mt-3 upload-field">
                    <input type="file" class="custom-file-input" id="adminProfileAvatarFile" accept="image/*">
                    <label class="custom-file-label" for="adminProfileAvatarFile">选择头像图片</label>
                </div>
                <button type="button"
                        class="btn btn-success btn-sm mt-3 js-upload-trigger"
                        onclick="uploadImage('#adminProfileAvatarFile','#adminProfileAvatar','#adminProfileAvatarPreview','#adminProfileAvatarEmpty')">上传图片</button>
        ...
        <div class="farmer-profile-main">
            ...
            <div class="farmer-profile-section">
                <div class="farmer-profile-section-head">
                    <h3>基本资料</h3>
                    <span>完善管理员资料，便于平台日常维护和联系</span>
                </div>
                <form method="post" action="${pageContext.request.contextPath}/admin/profile/save">
                    <input type="hidden" name="id" value="${entity.id}">
                    <input type="hidden" name="avatar" data-sync-group="admin-profile-avatar" value="${entity.avatar}">
