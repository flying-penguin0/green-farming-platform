...
<div class="container py-5">
    ...
    <div class="panel-card farmer-profile-card user-profile-card">
        <div class="farmer-profile-layout">
            <div class="farmer-profile-side">
                <div class="farmer-profile-avatar-card">
                    <div class="farmer-profile-avatar-box">
                        <img id="userProfileAvatarPreview" src="${entity.avatar}" alt="头像预览" class="${empty entity.avatar ? 'd-none' : ''}">
                        <div id="userProfileAvatarEmpty" class="register-avatar-empty ${empty entity.avatar ? '' : 'd-none'}">头像</div>
                    </div>

                    <input type="hidden"
                           id="userProfileAvatar"
                           class="js-image-url-input"
                           data-preview="#userProfileAvatarPreview"
                           data-empty="#userProfileAvatarEmpty"
                           data-sync-group="user-profile-avatar"
                           value="${entity.avatar}">

                    <div class="custom-file mt-3 upload-field">
                        <input type="file" class="custom-file-input" id="userProfileAvatarFile" accept="image/*">
                        <label class="custom-file-label" for="userProfileAvatarFile">选择头像图片</label>
                    </div>
                    <button type="button"
                            class="btn btn-success btn-sm mt-3 js-upload-trigger"
                            onclick="uploadImage('#userProfileAvatarFile','#userProfileAvatar','#userProfileAvatarPreview','#userProfileAvatarEmpty')">上传图片</button>
            ...
            <div class="farmer-profile-main">
                <div class="farmer-profile-section">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/user/profile/password">
                        <div class="form-row">
                ...
                <div class="farmer-profile-section">
                    <div class="farmer-profile-section-head">
                        <h3>基本资料</h3>
                        <span>完善个人信息，便于平台联系和服务</span>
                    </div>
                    <div class="mb-3">
                        <a class="btn btn-outline-secondary" href="${pageContext.request.contextPath}/user/center">返回个人中心</a>
                    </div>
                    <form method="post" action="${pageContext.request.contextPath}/user/profile/save">
                        <input type="hidden" name="id" value="${entity.id}">
                        <input type="hidden" name="avatar" data-sync-group="user-profile-avatar" value="${entity.avatar}">
